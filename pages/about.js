...
const AboutPage = () => {
  return (
    <>
      ...
      {/* Keywords Meta Tag */}
      <meta name="keywords" content="Hari Da, Prasath,Hariprasath R, sathyamangalam, web developer, software engineer, portfolio, background, experience, front-end developer, back-end developer, full-stack developer" />
